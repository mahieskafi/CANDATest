...
import com.canda.ca.presentation.weather.WeatherState
import com.canda.ca.presentation.weather.WeatherViewModel
...
class WeatherViewModelTest {
    ...
    fun setUpViewModel() {
        ...
        currentWeatherMock = FakeWeatherResponse().makeWeather()
        forecastWeatherMock = FakeWeatherResponse().makeWeatherList()

        application = mock(Application::class.java)
        locationClient = mock(FusedLocationProviderClient::class.java)
        locationTracker = TestAppLocationTracker(locationClient, application)
